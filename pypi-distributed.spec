...
Source0  : https://files.pythonhosted.org/packages/b9/34/e1a947f9facce7efae4a32e9887cef0c220833ad84952d742322aefe47dc/distributed-2022.5.1.tar.gz
...
%prep
%setup -q -n distributed-2022.5.1
cd %{_builddir}/distributed-2022.5.1
pushd ..
cp -a distributed-2022.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653411183
...
cp %{_builddir}/distributed-2022.5.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-distributed/f016083f7994387778fdc4beb07d80240f8bbd54
