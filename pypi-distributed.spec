...
Version  : 2022.6.1
Release  : 114
URL      : https://files.pythonhosted.org/packages/f5/0c/872bc3da61fe52c750446b29bc926643dd3ac2418380f86658fe122a759c/distributed-2022.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/f5/0c/872bc3da61fe52c750446b29bc926643dd3ac2418380f86658fe122a759c/distributed-2022.6.1.tar.gz
...
%prep
%setup -q -n distributed-2022.6.1
cd %{_builddir}/distributed-2022.6.1
pushd ..
cp -a distributed-2022.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656096443
...
cp %{_builddir}/distributed-2022.6.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-distributed/f016083f7994387778fdc4beb07d80240f8bbd54
