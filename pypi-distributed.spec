...
Version  : 2022.2.0
Release  : 103
URL      : https://files.pythonhosted.org/packages/f3/5c/80fc9cf920eebb6b3772d2b076c452047d2715d23b6afc512f4dcadddbb9/distributed-2022.2.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/f3/5c/80fc9cf920eebb6b3772d2b076c452047d2715d23b6afc512f4dcadddbb9/distributed-2022.2.0.tar.gz
...
%prep
%setup -q -n distributed-2022.2.0
cd %{_builddir}/distributed-2022.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644615710
...
cp %{_builddir}/distributed-2022.2.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-distributed/f016083f7994387778fdc4beb07d80240f8bbd54
