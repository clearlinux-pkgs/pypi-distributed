...
Version  : 2022.7.0
Release  : 115
URL      : https://files.pythonhosted.org/packages/b2/b4/cd1e06867bcadf169e581a0a6a84fdd09e00f76aa41f5331ccff7213d9c9/distributed-2022.7.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/b2/b4/cd1e06867bcadf169e581a0a6a84fdd09e00f76aa41f5331ccff7213d9c9/distributed-2022.7.0.tar.gz
...
%prep
%setup -q -n distributed-2022.7.0
cd %{_builddir}/distributed-2022.7.0
pushd ..
cp -a distributed-2022.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657478379
...
cp %{_builddir}/distributed-2022.7.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-distributed/f016083f7994387778fdc4beb07d80240f8bbd54
