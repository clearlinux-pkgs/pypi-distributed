...
%prep
%setup -q -n distributed-2022.4.0
cd %{_builddir}/distributed-2022.4.0
...
cp %{_builddir}/distributed-2022.4.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-distributed/f016083f7994387778fdc4beb07d80240f8bbd54
