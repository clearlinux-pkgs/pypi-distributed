...
Version  : 2022.6.0
Release  : 113
URL      : https://files.pythonhosted.org/packages/b6/6d/3cd4bd08a48dab409392f428d5d4cdedabeabd68f55661de970f36405342/distributed-2022.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/b6/6d/3cd4bd08a48dab409392f428d5d4cdedabeabd68f55661de970f36405342/distributed-2022.6.0.tar.gz
...
%prep
%setup -q -n distributed-2022.6.0
cd %{_builddir}/distributed-2022.6.0
pushd ..
cp -a distributed-2022.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655132067
...
cp %{_builddir}/distributed-2022.6.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-distributed/f016083f7994387778fdc4beb07d80240f8bbd54
